namespace Nez.Overlap2D.Runtime
{
    public class CompositeItemVO : MainItemVO
    {
        ...
        ///     standard way
        ///     (via zIndexMin/Max) and then subtracting the inverse of the child (O2DMainItem) layerDepth which uses
        ...
        public float calculateLayerDepthForChild(float zIndexMin, float zIndexMax, MainItemVO child,
            float zIndexMaxChild = 100)
        {
