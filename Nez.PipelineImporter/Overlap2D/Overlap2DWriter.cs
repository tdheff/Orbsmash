...
namespace Nez.Overlap2D
{
    ...
    public class Overlap2DWriter : ContentTypeWriter<SceneVO>
    {
        protected override void Write(ContentWriter writer, SceneVO scene)
        {
            ...
            writer.Write(new Color(scene.ambientColor[0], scene.ambientColor[1], scene.ambientColor[2],
                scene.ambientColor[3]));
...
//			public List<float> horizontalGuides;
        ...
        private void writeComposite(ContentWriter writer, CompositeVO composite, SceneVO scene)
        {
...
//				public float height;
        ...
        private void writeMainItem(ContentWriter writer, MainItemVO item, SceneVO scene)
        {
...
//			public PhysicsBodyDataVO physics;
        ...
        private void writeColorPrimitive(ContentWriter writer, ColorPrimitiveVO colorPrim, SceneVO scene)
        {
