...
namespace Nez.TextureAtlasGenerator
{
    ...
    public class TextureAtlasProcessor : ContentProcessor<string[], TextureAtlasContent>
    {
        ...
        private string getSpriteNameFromFilename(string filepath, string[] input)
        {
            try
            {
                if (flattenPaths)
        ...
        private void processDirectory(string directory, List<string> imagePaths, TextureAtlasContent textureAtlas)
        {
        ...
        private int[] processNinePatchTexture(TextureContent texture)
        {
