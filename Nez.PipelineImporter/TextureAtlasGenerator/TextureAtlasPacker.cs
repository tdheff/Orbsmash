...
namespace Nez.TextureAtlasGenerator
{
	...
	public static class TextureAtlasPacker
    {
	    ...
	    public static PixelBitmapContent<Color> packSprites(IList<BitmapContent> sourceSprites,
            ICollection<Rectangle> outputSprites, bool isCompressed, ContentProcessorContext context)
        {
	    ...
	    /// </summary>
	    private static PixelBitmapContent<Color> copySpritesToOutput(List<ArrangedSprite> sprites,
	    ...
	    /// </summary>
	    private static void positionSprite(List<ArrangedSprite> sprites, int index, int outputWidth)
        {
            var x = 0;
            var y = 0;
	    ...
	    /// </summary>
	    private static int findIntersectingSprite(List<ArrangedSprite> sprites, int index, int x, int y)
        {
	    ...
	    /// </summary>
	    private static int compareSpriteSizes(ArrangedSprite a, ArrangedSprite b)
        {
	    ...
	    /// </summary>
	    private static int compareSpriteIndices(ArrangedSprite a, ArrangedSprite b)
        {
	    ...
	    /// </summary>
	    private static int guessOutputWidth(List<ArrangedSprite> sprites)
        {
            // Gather the widths of all our sprites into a temporary list.
            var widths = new List<int>();

            foreach (var sprite in sprites) widths.Add(sprite.width);
