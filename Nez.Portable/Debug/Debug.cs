...
namespace Nez
{
    ...
    public static partial class Debug
    {
        ...
        private static readonly List<DebugDrawItem> _debugDrawItems = new List<DebugDrawItem>();
        private static readonly List<DebugDrawItem> _screenSpaceDebugDrawItems = new List<DebugDrawItem>();
