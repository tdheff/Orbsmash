...
namespace Nez.Tiled
{
    public class TiledImageLayer : TiledLayer
    {
        ...
        public override void draw(Batcher batcher, Vector2 parentPosition, Vector2 scale, float layerDepth,
            RectangleF cameraClipBounds)
        {
            batcher.draw(texture, parentPosition + offset, null, Color.White, 0, Vector2.Zero, scale,
