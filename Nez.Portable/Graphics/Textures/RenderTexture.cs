...
namespace Nez.Textures
{
	...
	public class RenderTexture : IDisposable
    {
        ...
        {
            renderTarget = RenderTarget.create(Screen.width, Screen.height, Screen.backBufferFormat,
        ...
        {
            renderTarget =
                RenderTarget.create(Screen.width, Screen.height, Screen.backBufferFormat, preferredDepthFormat);
        }
        ...
        {
            renderTarget =
                RenderTarget.create(width, height, Screen.backBufferFormat, Screen.preferredDepthStencilFormat);
        }
