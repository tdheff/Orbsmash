...
namespace Nez.UI
{
	...
	public class TextField : Element, IInputListener, IKeyboardListener
    {
        ...
        private readonly List<float> glyphPositions = new List<float>(15);
        ...
        public override void draw(Graphics graphics, float parentAlpha)
        {
            ...
            var background = disabled && style.disabledBackground != null ? style.disabledBackground
        ...
        {
            selection.draw(graphics, x + selectionX + renderOffset + fontOffset, y - font.descent / 2, selectionWidth,
