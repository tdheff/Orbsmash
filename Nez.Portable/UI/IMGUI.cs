...
namespace Nez
{
	...
	public class IMGUI
    {
        ...
        private static readonly SpriteBatch _spriteBatch;
        private static readonly BitmapFont _font;
        private static readonly Vector2 FONT_SCALE;
        private static readonly Color FONT_COLOR = new Color(255, 255, 255);
        private static readonly Color WINDOW_COLOR = new Color(17, 17, 17);
        private static readonly Color BUTTON_COLOR = new Color(78, 91, 98);
        private static readonly Color BUTTON_COLOR_ACTIVE = new Color(168, 207, 115);
        private static readonly Color BUTTON_COLOR_DOWN = new Color(244, 23, 135);
        private static readonly Color TOGGLE_BG = new Color(63, 63, 63);
        private static readonly Color TOGGLE_BG_ACTIVE = new Color(130, 130, 130);
        private static readonly Color TOGGLE_ON = new Color(168, 207, 115);
        private static readonly Color TOGGLE_ON_ACTIVE = new Color(244, 23, 135);
        private static readonly Color SLIDER_BG = new Color(78, 91, 98);
        private static readonly Color SLIDER_THUMB_BG = new Color(25, 144, 188);
        private static readonly Color SLIDER_THUMB_BG_ACTIVE = new Color(168, 207, 115);
        private static readonly Color SLIDER_THUMB_BG_DOWN = new Color(244, 23, 135);
        private static readonly Color HEADER_BG = new Color(40, 46, 50);
...
#pragma warning disable 0414
            ...
            float elementHeight = ELEMENT_HEIGHT)
        {
            ...
            _spriteBatch.DrawString(_font, text, new Vector2(x, y), color, 0, Vector2.Zero, FONT_SCALE,
        ...
        public static bool toggle(string text, bool isChecked)
        {
            ...
            if (isChecked || isToggleActive)
                _spriteBatch.drawRect(toggleX + 3, _lastY + ELEMENT_PADDING + 3, ELEMENT_HEIGHT - 6, ELEMENT_HEIGHT - 6,
                    toggleCheckColor);
        ...
        public static float slider(float value, string name = "")
        {
            ...
            _spriteBatch.drawRect(_elementX + thumbPos, _lastY + ELEMENT_PADDING, SHORT_ELEMENT_HEIGHT,
        ...
        public static void header(string text)
        {
            ...
            _spriteBatch.drawRect(_elementX - ELEMENT_PADDING, _lastY + ELEMENT_PADDING,
